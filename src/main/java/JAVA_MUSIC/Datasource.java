...
public class Datasource {
    ...
    public static final String DatabaseName = "music.db";

    public static final String CONNECTION_STRING = "jdbc:sqlite:S:\\Java Test Projects\\Final Project\\Download\\src\\main\\resources\\" + DatabaseName;
